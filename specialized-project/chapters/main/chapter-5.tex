...
\subsection{Phân hệ Học sinh (Student Dashboard)}
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item \textbf{Phản hồi tức thì:} Ngay sau khi học sinh submit, hệ thống tính toán xác suất đúng/sai và cập nhật Elo ngay lập tức (thể hiện qua các thông số debug log bên phải màn hình nếu ở chế độ dev).
\end{itemize}
...
\subsection{Phân hệ Giáo viên (Teacher Analytics)}
...
\begin{itemize}[leftmargin=1.5cm]
    ...
    \item \textbf{Phân tích quỹ đạo (Learning Trajectory):} Biểu đồ minh chứng cho việc giảm "Zigzag giả" và sự tiến bộ ổn định.
